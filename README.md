...
| Définir comme templates-enfants les 2 templates déjà créés (grille photo, liste des vins groupés par pays) | Afficher une lightbox contenant la photo et toutes les données du vin cliqué lorsque l'on clique sur une des miniatures **-Ok** |
| Spécifier dans ces templates-enfants le contenu des blocs définit dans le layout principal | Ajouter un menu de pagination **-Ok** |